...
export default function SizeGuideModal({ isOpen, onClose }: SizeGuideModalProps) {
  ...
  // تم استبعاد 2XL برمجياً ليتطابق مع مخزون المتجر (S to XL)
  const sizeData = [
      ...
      <div className="relative w-full max-w-2xl bg-[#0d0d0d] border border-[#222] rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#222] bg-[#121212]">
          <h2 className="text-xl font-black uppercase tracking-tight text-white flex items-center gap-2">
            ...
            Player Version <span className="text-[#00AEEF]">Size Chart</span>
          </h2>
          <button 
            onClick={onClose}
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[#222]">
                ...
                <th className="py-3 px-4 text-xs font-extrabold text-[#00AEEF] uppercase tracking-wider flex items-center gap-1.5">
                  <User className="w-3.5 h-3.5" /> Height & Weight
                </th>
              </tr>
            </thead>
        ...
        <div className="p-4 bg-[#121212] border-t border-[#222] flex items-start gap-3">
          ...
          <p className="text-xs text-gray-400 leading-relaxed font-medium">
            <strong className="text-white">Fit Advice:</strong> Player version kits feature an athletic, slim fit designed for performance. If you prefer a looser fit, we highly recommend choosing one size larger than your usual standard size.
          </p>
        </div>
